 ...
 * @method Cms_Model_Auth_Query_Field andField() andField($fieldName, $tableName = null)
 * @method Cms_Model_Auth_Query_Field where() where($fieldName, $tableName = null)
 * @method Cms_Model_Auth_Query_Field orField() orField($fieldName, $tableName = null)
 * @method Cms_Model_Auth_Query_Join join() join($tableName, $targetTableName = null)
 * @method Cms_Model_Auth_Query_Join joinLeft() joinLeft($tableName, $targetTableName = null)
 * @method Cms_Model_Auth_Record[] find() find()
 * @method Cms_Model_Auth_Record findFirst() findFirst()
 */
class Cms_Model_Auth_Query extends Mmi_Dao_Query {

	/**
	 * @return Cms_Model_Auth_Query
	 */
