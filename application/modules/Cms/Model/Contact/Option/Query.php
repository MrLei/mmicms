 ...
 * @method Cms_Model_Contact_Option_Query andField() andField($fieldName, $tableName = null)
 * @method Cms_Model_Contact_Option_Query where() where($fieldName, $tableName = null)
 * @method Cms_Model_Contact_Option_Query orField() orField($fieldName, $tableName = null)
...
class Cms_Model_Contact_Option_Query extends Mmi_Dao_Query {
	...
	public function __construct() {
		return parent::__construct('Cms_Model_Contact_Option_Dao');
	}
