 ...
 * @method Cms_Model_Contact_Query_Join join() join($tableName, $targetTableName = null)
 * @method Cms_Model_Contact_Query_Join joinLeft() joinLeft($tableName, $targetTableName = null)
