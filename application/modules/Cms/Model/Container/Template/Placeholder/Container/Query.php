 ...
 * @method Cms_Model_Container_Template_Placeholder_Container_Query_Field andField() andField($fieldName, $tableName = null)
 * @method Cms_Model_Container_Template_Placeholder_Container_Query_Field where() where($fieldName, $tableName = null)
 * @method Cms_Model_Container_Template_Placeholder_Container_Query_Field orField() orField($fieldName, $tableName = null)
