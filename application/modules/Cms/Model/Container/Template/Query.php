 ...
 * @method Cms_Model_Container_Template_Query_Field andField() andField($fieldName, $tableName = null)
 * @method Cms_Model_Container_Template_Query_Field where() where($fieldName, $tableName = null)
 * @method Cms_Model_Container_Template_Query_Field orField() orField($fieldName, $tableName = null)
 ...
 * @method Cms_Model_Container_Template_Record findFirst() findFirst()
 */
class Cms_Model_Container_Template_Query extends Mmi_Dao_Query {

	/**
	 * @return Cms_Model_Container_Template_Query
	 */
