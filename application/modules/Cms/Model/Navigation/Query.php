 ...
 * @method Cms_Model_Navigation_Query_Field andField() andField($fieldName, $tableName = null)
 * @method Cms_Model_Navigation_Query_Field where() where($fieldName, $tableName = null)
 * @method Cms_Model_Navigation_Query_Field orField() orField($fieldName, $tableName = null)
 * @method Cms_Model_Navigation_Query_Join join() join($tableName, $targetTableName = null)
 * @method Cms_Model_Navigation_Query_Join joinLeft() joinLeft($tableName, $targetTableName = null)
 * @method Cms_Model_Navigation_Record[] find() find()
 * @method Cms_Model_Navigation_Record findFirst() findFirst()
 */
