 ...
 * @method Cron_Model_Query andField() andField($fieldName, $tableName = null)
 * @method Cron_Model_Query where() where($fieldName, $tableName = null)
