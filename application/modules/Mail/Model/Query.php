 ...
 * @method Mail_Model_Query andField() andField($fieldName, $tableName = null)
 * @method Mail_Model_Query where() where($fieldName, $tableName = null)
 * @method Mail_Model_Query orField() orField($fieldName, $tableName = null)
...
class Mail_Model_Query extends Mmi_Dao_Query {
	...
	public function __construct() {
		return parent::__construct('Mail_Model_Dao');
	}
