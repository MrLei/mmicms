 ...
 * @method Mail_Model_Server_Query_Join join() join($tableName, $targetTableName = null)
 * @method Mail_Model_Server_Query_Join joinLeft() joinLeft($tableName, $targetTableName = null)
 * @method Mail_Model_Server_Record[] find() find()
