 ...
 * @method Stat_Model_Date_Query_Join join() join($tableName, $targetTableName = null)
 * @method Stat_Model_Date_Query_Join joinLeft() joinLeft($tableName, $targetTableName = null)
