...
CREATE INDEX "fki_cms_navigation_id_fkey" ON "cms_page"("cms_navigation_id");
CREATE INDEX "fki_cms_route_id_fkey" ON "cms_page"("cms_route_id");
CREATE INDEX "fki_cms_auth_id_fkey" ON "cms_page"("cms_auth_id");
